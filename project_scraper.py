...
class project(author):
    ...
    def project_difficulty_function(self):
        try:
            ...
            print("project_diffictulty_function error")
    ...
    def project_instruction_function(self):
        try:
            ...
            print("project_instruction_function error")
    ...
    def project_number_of_words_function(self):
        try:
            ...
            print("project_number_of_words_function error")
...
#aut_1 = project("Kai", "KS@gmail.com", "2", "1", "3", "Wurstwasserspiel", "1222","12", "1", "3", "easy", "1", "12312", "5", "1", "0")
#aut_1.difficulty = aut_1.project_difficulty_function("https://www.hackster.io/Itverkx/safe-shutdown-and-auto-bootup-for-raspberry-pi-2edb5b")
#print(aut_1.difficulty)
#print(aut_1.user_name)
#print(aut_1)
